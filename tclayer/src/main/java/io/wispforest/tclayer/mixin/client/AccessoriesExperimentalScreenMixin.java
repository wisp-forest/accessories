...
public abstract class AccessoriesExperimentalScreenMixin {
    ...
    @WrapOperation(method = "renderSlotTexture(Lnet/minecraft/client/gui/GuiGraphics;Lnet/minecraft/world/inventory/Slot;Lnet/minecraft/world/item/ItemStack;)V", at = @At(value = "INVOKE", target = "Lnet/minecraft/client/gui/GuiGraphics;blit(IIIIILnet/minecraft/client/renderer/texture/TextureAtlasSprite;)V"))
