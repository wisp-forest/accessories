...
//    private void adjustButtonRendering(GuiGraphicsExtractor instance, Function<Identifier, RenderType> function, Identifier resourceLocation, int x, int y, int width, int height, int m, Operation<Void> original) {
