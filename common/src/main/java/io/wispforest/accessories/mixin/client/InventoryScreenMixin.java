...
public abstract class InventoryScreenMixin {
    ...
    private static void accessories$wrapWithArmorLookup(GuiGraphicsExtractor guiGraphics, int x1, int y1, int x2, int y2, int scale, float yOffset, float mouseX, float mouseY, LivingEntity entity, Operation<Void> original) {
