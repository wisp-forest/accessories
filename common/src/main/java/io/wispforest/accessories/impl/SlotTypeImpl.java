...
public record SlotTypeImpl(String name, ResourceLocation icon, int order, int amount, Set<ResourceLocation> validators, SlotType.DropRule dropRule) implements SlotType  {
    ...
    public static final MapCodec<SlotType> CODEC = RecordCodecBuilder.mapCodec(instance -> {
        return instance.group(
                    ...
                    Codec.STRING.xmap(SlotType.DropRule::valueOf, SlotType.DropRule::name).fieldOf("dropRule").forGetter(SlotType::dropRule)
