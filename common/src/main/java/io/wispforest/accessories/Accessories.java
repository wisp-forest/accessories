...
public class Accessories {
    ...
    public static void init() {
        ...
        AllowEntityModificationCallback.EVENT.register((target, player, reference) -> {
            ...
            if(type.builtInRegistryHolder().is(AccessoriesTags.MODIFIABLE_ENTITY_BLACKLIST)) return TriState.FALSE;
            ...
            if(isOwnersPet || type.builtInRegistryHolder().is(AccessoriesTags.MODIFIABLE_ENTITY_WHITELIST)) return TriState.TRUE;
